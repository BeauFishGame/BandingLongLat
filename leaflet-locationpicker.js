	...
	$.fn.leafletLocationPicker = function(opts, onChangeLocation) {
		...
		var baseClassName = 'leaflet-locpicker',
			baseLayers = {
				...
				'OSM2':http + '//server.arcgisonline.com/ArcGIS/rest/services/World_Street_Map/MapServer/tile/{z}/{y}/{x}',

				'OSM3':http + '//basemaps.linz.govt.nz/v1/tiles/aerial/WebMercatorQuad/{z}/{x}/{y}.webp?api=c01jt4pgzmwtt5ybqgsf2ntnvrj'
		...
		function buildMap(self) {
			...
			var LINZ = L.tileLayer('https://basemaps.linz.govt.nz/v1/tiles/aerial/WebMercatorQuad/{z}/{x}/{y}.webp?api=c01jt4pgzmwtt5ybqgsf2ntnvrj', {
				attribution: 'LINZ'
			});

			var LINZTOPO = L.tileLayer('https://basemaps.linz.govt.nz/v1/tiles/topo-raster/WebMercatorQuad/{z}/{x}/{y}.webp?api=c01jt4pgzmwtt5ybqgsf2ntnvrj', {
				attribution: 'LINZ'
			});
			...
			var defaultLayer = LINZTOPO;  // or esri if you prefer
			opts.map.layers = defaultLayer;
			...
			defaultLayer.addTo(self.map);  // Add the default layer
